...
CREATE TABLE entries (id INTEGER CONSTRAINT "UNIQUE" PRIMARY KEY AUTOINCREMENT UNIQUE NOT NULL, title TEXT, url TEXT, body TEXT, image BLOB, datetime STRING NOT NULL, user_id INTEGER NOT NULL);